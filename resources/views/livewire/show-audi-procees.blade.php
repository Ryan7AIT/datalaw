<div>
    <div class="edit   h-full overflow-hidden pl-10 ">
        <main id="dashboard-main" class="h-[calc(100vh-8rem)] overflow-auto px-4 py-10">
            ...
            <div class="grid grid-cols-8 pt-3 pb-10 sm:grid-cols-10">
                ...
                <div class="pt-4">
                    <h1 class="py-2 text-2xl font-semibold">Traitment 1 HR</h1>
                    <!-- <p class="font- text-slate-600">Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p> -->
                </div>
                <hr class="mt-4 mb-8" />
                <p class="py-2 text-xl font-semibold">Auditeur</p>
                <div class="space-y-2">
                    <div class="cursor-pointer rounded-md border bg-white px-6 py-2 text-2xl hover:bg-blue-50">AIT MECHEDAL Ryan</div>
                </div>
                <hr class="mt-4 mb-8" />
                <p class="py-2 text-xl font-semibold">Detail Audit</p>
                <div class="space-y-1">
                    <div x-data="{ open: false }"  class="rounded-md border bg-white">
                        <div class="flex w-full items-center px-6 py-2">
                            ...
                            <span @click="open = !open" class="cursor-pointer"> Base legal</span>
                                ...
                                <div class="mt-6 overflow-hidden rounded-xl border shadow">
                                    <table class="min-w-full border-separate border-spacing-y-2 border-spacing-x-2">
                                        ...
                                        <tbody class="lg:border-gray-300">
                                            <tr class="">
                                                <td wire:click="showSideBar"  width="50%" class="whitespace-no-wrap cursor-pointer py-4 text-sm font-bold text-gray-900 sm:px-6">
                                                    Quel est le fondemant legal de ce traitmnet ?
                    ...
                    <div class="flex w-full items-center px-6 py-2">
                        ...
                        <span>Confidante et securite</span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="ml-auto h-5 w-5 cursor-pointer text-gray-400 active:scale-95" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                        </svg>
                    </div>
    ...
    @if($showLeftBar)
        ...
        <div class="fixed top-0 right-0 w-4/5 border shadow z-50 bg-white h-full transition">
            ...
            <div class="desc px-6 py-4 mt-8">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi, ipsam! Natus in quam ea blanditiis excepturi voluptates cum quas maxime ratione alias ipsum culpa, magnam rem quis facilis numquam delectus.</p>


                <h4 class="text-gray-400 mt-2">Titre</h4>
                <p>Communication des donnees a un tier</p>
            </div>

            <div class="verification px-6 py-4 mt-8">
                <h1 class="font-semibold text-lg">Verification additionnelles</h1>

                <table class="min-w-full border-separate border-spacing-y-2 border-spacing-x-2 rounded-xl border shadow">
                    <thead class="hidden border-b lg:table-header-group">
                        <tr class="">
