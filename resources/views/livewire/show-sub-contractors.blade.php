<div x-data="{ showAddStep: false }" >
    ...
    <div class="mx-auto mt-8 max-w-screen-lg px-2">
      <div class="sm:flex sm:items-center sm:justify-between flex-col sm:flex-row">
        <p class="flex-1 text-base font-bold text-gray-900">Sous Traitant</p>
        ...
        <table class="w-full border-separate border-spacing-y-2 border-spacing-x-2">
          <thead class=" border-b lg:table-header-group">
            <tr class="">
              ...
              <td class="whitespace-normal py-4 text-sm font-medium text-gray-500 sm:px-2 mx-auto text-center">Sous Traitant </td>
              <td class="whitespace-normal py-4 text-sm font-medium text-gray-500 sm:px-2 mx-auto text-center">Adress </td>
              <td class="whitespace-normal py-4 text-sm font-medium text-gray-500 sm:px-2 mx-auto text-center">Email</td>
          ...
          <tbody class="lg:border-gray-300">
           @forelse ($subContractors as $subContractor )
            ...
            <td  class="whitespace-no-wrap py-4 text-sm font-bold  text-gray-900 sm:px-6">
                <a target="_blank" href="{{ asset('storage/' . $subContractor->path )}} ">Contart</a>
    ...
    <div
          ...
          x-show="showAddStep" x-transition  class="modal absolute  right-64 bottom-2 w-1/2 mr-32 z-50 transition ease-in-out bg-white text-black border rounded-lg py-8 px-6">
            <h2 class="text-center mb-4">Nevau Sous Traitant</h2>
            ...
            <div class="lg:m-2">
                <form wire:submit.prevent="submit" class="relative space-y-3 max-w-screen-md mx-auto  p-4  lg:p-6">
                    ...
                    <div class="grid gap-3 md:grid-cols-2 space-x-8">
                        <div>
                            <label class=""> Prenome du responsable </label>
                            <input  wire:model.defer="fname" type="text" placeholder="Your Name" class="mt-2 h-12 w-full rounded-md bg-gray-100 px-3" />
                            @error('fname') <span class="error">{{ $message }}</span> @enderror

                        </div>
                        <div>
                            <label class=""> Nom du responsable </label>
                            <input wire:model.defer="lname" type="text" placeholder="Last  Name" class="mt-2 h-12 w-full rounded-md bg-gray-100 px-3" />
                    ...
                    <div>
                        ...
                        <input wire:model.defer="email" type="email" placeholder="Info@example.com" class="mt-2 h-12 w-full rounded-md bg-gray-100 px-3" />
                    ...
                    <div>
                        ...
                        <label for="message" class="block  mb-2 text-sm font-medium text-gray-900 dark:text-white">Raison Social</label>
                        <textarea wire:model.defer="description" id="message" rows="4" class="block resize-none p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Write your thoughts here..."></textarea>
                    ...
                    <div>
                        ...
                        <input  wire:model.defer="number" type="tel" placeholder="Your Name" class="mt-2 h-12 w-full rounded-md bg-gray-100 px-3" />
                        @error('fname') <span class="error">{{ $message }}</span> @enderror

                    </div>
                    <div>

                            <label class="block mb-2 text-sm font-medium text-gray-900 " for="file_input">Contrat</label>
